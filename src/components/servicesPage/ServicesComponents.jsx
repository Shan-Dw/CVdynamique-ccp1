...
export default function ServicesComponents() {
  ...
  return (
    <div>
      ...
      <button
        type="submit"
        class="text-white mt-20 bg-[#8583e1] hover:bg-[#6a69b8] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
        Send Message
      </button>
    </div>
